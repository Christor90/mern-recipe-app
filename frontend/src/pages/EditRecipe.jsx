...
const EditRecipe = () => {
  ...
  return (
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 mt-10">
      <div className="w-full max-w-2xl p-6 border border-gray-200 shadow-md rounded-2xl bg-white">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label className="block text-gray-500 mb-1">Ingredients</label>
            {formData.ingredients.map((ingredient, index) => (
          ...
          <div>
            <label className="block text-gray-500 mb-1">Instructions</label>
            <textarea
              value={formData.instructions}
              onChange={(e) =>
